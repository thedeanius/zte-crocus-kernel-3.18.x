...
static int driver_init_partial(struct gf_dev *gf_dev)
{
	...
	FUNC_ENTRY();
	pr_info("--------driver_init_partial start.--------\n");
...
extern bool is_goodix_fp_gf3208(void);
static int __init gf_init(void)
{
	...
	if (is_goodix_fp_gf3208()) {
		pr_info("<HW> Goodix GF3208 fingerprint hw detected\n");
	} else {
		pr_info("<HW> not GF3208 Goodix fingerprint hw, skip\n");
		goto out;
	}
